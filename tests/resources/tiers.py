...
def integration_test(test):
    ...
    Integration tests should live in the `common_utils_py/test/integration` folder and
    `common_utils_py/<package>/test` folders of individual sub-packages.
    """
...
def e2e_test(test):
    ...
    End-to-end tests should live in the `common_utils_py/test/e2e` and `common_utils_py/examples` folders.
    """
